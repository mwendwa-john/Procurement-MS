            ...
            <main id="content">
                <div class="max-w-[85rem] w-full mx-auto flex flex-row justify-start py-3 px-4 sm:px-6 lg:px-8">
                    <h1 class="text-lg text-gray-800 font-medium">
                        Invoices from {{ $supplier->supplier_name }}
                    </h1>
                </div>
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <h2 class="text-lg font-semibold text-blue-600">
                                                Invoice Payments from {{ $supplier->supplier_name }}
                                            </h2>
                                        </div>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="divide-y divide-gray-200">
                                            @forelse ($suplierInvoices as $invoice)
                                            <tr class="hover:bg-gray-100">
                                                <td class="ps-6 py-3 text-blue-600">
                                                    <div class="text-sm font-semibold">
                                                        {{ ($suplierInvoices->currentPage() - 1) *
                                                        $suplierInvoices->perPage() +
                                                        $loop->index + 1 }}
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-1.5">
                                                    <div class="text-base font-bold text-blue-600">
                                                        Ksh {{ number_format($suplierInvoices->sum('total_amount'), 2)
                                                        }}
                                        ...
                                        <div>
                                            <p class="text-sm text-gray-600">
                                                <span class="font-semibold text-gray-800">
                                                    {{ $suplierInvoices->total() }}
                                                </span> Suplier Invoices
                                            </p>
                                        </div>
                                        {{ $suplierInvoices->links('vendor.pagination.custom') }}
                                    </div>
                                    <!-- End Footer -->
                                </div>
                            </div>
