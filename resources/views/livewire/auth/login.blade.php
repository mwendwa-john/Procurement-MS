...
<div class="mx-auto">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <a href="{{ route('home') }}">
            <img class="w-auto h-16 mx-auto" src="{{ asset('front-assets/images/superiorLogo.png') }}" alt="logo">
        </a>
            ...
            <form wire:submit.prevent="authenticate">
                ...
                <div class="flex items-center mt-5">
                    <input wire:model.lazy="remember" id="remember" type="checkbox"
                        class="shrink-0 mt-0.5 border-blue-300 rounded text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none transition duration-150 ease-in-out" />
