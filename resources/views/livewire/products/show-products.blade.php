<div class="bg-sky-50">
    ...
    <div class="relative overflow-hidden">
        ...
        <div aria-hidden="true" class="flex absolute -top-96 start-1/2 transform -translate-x-1/2">
            ...
            <div
                class="bg-gradient-to-br from-lime-400/50 via-lime-300 to-lime-200 blur-3xl w-[25rem] h-[44rem] rotate-[-60deg] transform -translate-x-[10rem]">
            </div>
            <div
                class="bg-gradient-to-tl from-lime-100 via-lime-200 to-lime-100 blur-3xl w-[90rem] h-[50rem] rounded-full origin-top-left -rotate-12 -translate-x-[15rem]">
            </div>
                                                ...
                                                <tr class="hover:bg-gray-100">
                                                    ...
                                                    <td class="px-6 py-1.5 text-center">
                                                        <div class="inline-flex gap-2">
                                                            ...
                                                            <button
                                                                wire:click="$dispatch('pass-product-edit-id', { id: '{{ $product->id }}' })"
