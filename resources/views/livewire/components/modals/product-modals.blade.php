<div>
    <!--Create Products-->
    <div wire:ignore.self id="hs-modal-add-product"
    ...
    <!--View Product-->
    <div wire:ignore.self id="hs-modal-view-product"
        class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto">
        <div
            class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
            ...
            <div class="relative flex flex-col bg-white shadow-lg rounded-xl">
                <div class="absolute top-2 end-2">
                    <button type="button"
                        class="flex justify-center items-center size-7 text-sm font-semibold rounded-lg border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none"
                        data-hs-overlay="#hs-modal-view-product">
                        <span class="sr-only">Close</span>
                        <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="p-4 sm:p-10 text-center overflow-y-auto">
                    <h3 class="mb-2 text-2xl font-bold text-orange-400">
                        View Product
                    </h3>
                    <p class="text-orange-400">
                        view a system product
                    </p>
                        ...
                        <div class="relative">
                            <div class=" space-y-3">
                                <dl class=" sm:flex gap-x-3 text-sm">
                                    ...
                                    <dd
                                        class="font-medium text-gray-800 mx-4 px-4 py-2 block w-full rounded-lg text-sm bg-gray-100">
                                        {{ $item_name }}
                                    </dd>
                                </dl>
    ...
    <!--Edit Products-->
    <div wire:ignore.self id="hs-modal-edit-product"
        class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto">
        <div
            class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                    ...
                    <div class="mt-5">
                        <x-livewire-forms submitAction="editProduct" formId="editProductForm">
                            ...
                            <div class="grid grid-cols-2 gap-y-4 gap-x-8">
                                ...
                                <div>
                                    <label for="unit_of_measure" class="block text-sm mb-2 text-start">Unit Of Measure
                                        *</label>
    ...
    <!--Delete Product -->
    <div wire:ignore.self id="hs-modal-delete-product"
        class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto">
        <div
                    ...
                    <div class="flex gap-x-4 md:gap-x-7">
                        ...
                        <div class="grow">
                            ...
                            <p class="text-gray-500 flex flex-col items-center">
                                <span class="text-center">Temporarily delete this product.</span>
    ...
    <!--Restore Product -->
    <div wire:ignore.self id="hs-modal-restore-product"
        class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto">
        <div
            class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all md:max-w-2xl md:w-full m-3 md:mx-auto">
            <div class="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden">
                ...
                <div class="flex justify-end items-center gap-x-2 py-3 px-4 bg-gray-50 border-t">
                    ...
                    <button wire:click='restoreProduct'
                        class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-500 text-white hover:bg-red-600 disabled:opacity-50 disabled:pointer-events-none">
                        Restore product
                    </button>
                </div>
