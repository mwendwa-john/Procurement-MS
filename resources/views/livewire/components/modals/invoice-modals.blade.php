<div>
    ...
    <!--Delete invoice -->
    <div wire:ignore.self id="hs-modal-delete-invoice"
                    ...
                    <div class="flex gap-x-4 md:gap-x-7">
                        ...
                        <div class="grow">
                            ...
                            <p class="text-gray-500 flex flex-col items-center">
                                <span class="text-center">Temporarily delete this invoice.</span>
                                This action is reversible, but you cannot delete invoices that have payments associated to
