                                            ...
                                            <thead class="bg-gray-50">
                                                <tr>
                                                    ...
                                                    <th scope="col" class="px-6 py-3 text-center">
                                                        <span
                                                            class="text-xs font-semibold uppercase tracking-wide text-blue-600">Stage</span>
                                                    </th>

                                                    <th scope="col" class="px-6 py-3 text-start">
                                                        <span
                                                            class="text-xs font-semibold uppercase tracking-wide text-blue-600">Order Number</span>
                                                    </th>

                                                    <th scope="col" class="px-6 py-3 text-center">
                                                        <span
                                                            class="text-xs font-semibold uppercase tracking-wide text-blue-600">Action</span>
                                                    </th>
                                            ...
                                            <tbody class="divide-y divide-gray-200">
                                                ...
                                                <tr>
                                                    <td colspan="6" class="text-center py-3">
                                                        <span class="text-sm font-semibold text-red-400">No LPOs
                                                            available</span>
                                                    </td>
                                                </tr>
                                                @endforelse
