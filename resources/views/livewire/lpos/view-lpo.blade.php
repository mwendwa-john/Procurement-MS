            ...
            <div class="relative z-10">
                <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-2 lg:py-16">
                    <div class="max-w-2xl text-center mx-auto">
                        ...
                        @livewire('lpos.view-lpo-invoices-buttons', ['lpoNumber' => $lpo->lpo_order_number])
                    </div>
                    ...
                    <main id="content">
                        ...
                        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto my-4 sm:my-10">
                            <div class="bg-white border rounded-xl shadow-sm
                                @if($lpo->status === 'generated') border-blue-500
                                @elseif($lpo->status === 'partially_delivered') border-red-400
                                @elseif($lpo->status === 'delivered') border-teal-400
                                            ...
                                            <div class="w-full max-w-2xl sm:text-end space-y-2">
                                                ...
                                                <div class="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                                                    <dl class="grid sm:grid-cols-5 gap-x-3 text-sm">
                                                        <dt class="col-span-3 font-medium text-gray-800">Created by:
                                                        </dt>
                                                    ...
                                                    <dl class="grid sm:grid-cols-5 gap-x-3 text-sm">
                                                        <dt class="col-span-3 font-medium text-gray-800">Posted by:</dt>
                                                        <dd class="col-span-2 text-gray-500">
                                                    ...
                                                    <dl class="grid sm:grid-cols-5 gap-x-3 text-sm">
                                                        <dt class="col-span-3 font-medium text-gray-800">Added to Daily
                                                            Lpo
                                                            by:</dt>
                                                        <dd class="col-span-2 text-gray-500">
                                                    ...
                                                    <dl class="grid sm:grid-cols-5 gap-x-3 text-sm">
                                                        <dt class="col-span-3 font-medium text-gray-800">Approved by:
                                                        </dt>
                                                        <dd class="col-span-2 text-gray-500">
                                                    ...
                                                    <dl class="grid sm:grid-cols-5 gap-x-3 text-sm">
                                                        <dt class="col-span-3 font-medium text-gray-800">
                                                            Invoice attached by:
                                                        </dt>
                                                        <dd class="col-span-2 text-gray-500">
