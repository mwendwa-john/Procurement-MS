                                        ...
                                        <div class="w-full max-w-2xl sm:text-end space-y-2">
                                            ...
                                            <div class="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                                                <dl class="grid sm:grid-cols-5 gap-x-3 text-sm">
                                                    <dt class="col-span-3 font-medium text-gray-800">Generated by:</dt>
                                                ...
                                                <dl class="grid sm:grid-cols-5 gap-x-3 text-sm">
                                                    <dt class="col-span-3 font-medium text-gray-800">Added to Daily Lpo
                                                        by:</dt>
                                                    <dd class="col-span-2 text-gray-500">
                                                        {{ $addedToDailyLpoBy ?? 'N/A' }}
                                                    </dd>
                                                </dl>

                                                <dl class="grid sm:grid-cols-5 gap-x-3 text-sm">
                                                    <dt class="col-span-3 font-medium text-gray-800">Approved by:</dt>
                                                    <dd class="col-span-2 text-gray-500">
                                                        {{ $approvedBy ?? 'N/A' }}
                                                    </dd>
                                                </dl>
