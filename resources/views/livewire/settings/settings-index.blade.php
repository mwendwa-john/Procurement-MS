...
<div>
        ...
        <div
            ...
            <div x-data="{ activeTab: @entangle('activeTab') }">
                <button @click="activeTab = 'global'"
                    class="py-2 px-3 inline-flex items-center text-sm font-medium rounded-full border-2 border-white text-white hover:border-white/70 hover:text-white/70">
                    Global Settings
                </button>
    ...
    <div x-data="{ activeTab: @entangle('activeTab') }">
        ...
        <div class="mt-6">
            ...
            <div x-show="activeTab === 'global'" x-transition:enter="transition ease-out duration-300"
                ...
                <p>Here you can configure global settings.</p>

                @livewire('settings.global-settings')
            </div>
            ...
            <div x-show="activeTab === 'system'" x-transition:enter="transition ease-out duration-300"
                ...
                <p>Here you can configure system settings.</p>
