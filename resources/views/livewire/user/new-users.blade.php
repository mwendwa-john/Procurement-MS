...
<div>
    ...
    <div class="flex justify-between items-center mt-4">
        <h4 class="text-xl font-semibold">Active & Inactive Users Registered Within A Month</h4>
                                ...
                                <tr>
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-1.5">
                                            <a class="inline-flex mx-1 items-center gap-x-1 text-sm text-orange-400 decoration-2 hover:underline font-medium"
                                                href="{{ route('user.profile', ['slug' => $user->slug]) }}">
                                                View
                                            </a>

                                            <a class="inline-flex mx-1 items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium"
                                                href="#">
                                                Activate & Assign Hotel
                                            </a>

                                            <a class="inline-flex mx-1 items-center gap-x-1 text-sm text-red-400 decoration-2 hover:underline font-medium"
                                                href="#">
                                                Delete
                                            </a>
                                        </div>
                                    ...
                                    <td colspan="6" class="text-center">
                                        <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                            <div class="flex justify-center items-center gap-x-3">
                                                <div class="grow">
                                                    <span class="block text-sm font-semibold text-gray-800">
                                                        No users registered in the system within the last month
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
