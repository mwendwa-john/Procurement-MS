<div class="bg-purple-50">
    ...
    <div class="relative overflow-hidden">
        ...
        <div aria-hidden="true" class="flex absolute -top-96 start-1/2 transform -translate-x-1/2">
            <div
                class="bg-gradient-to-r from-yellow-200 via-orange-100 to-red-50 blur-3xl w-screen h-screen rotate-[-60deg] transform -translate-x-[10rem]">
            </div>
            <div
                class="bg-gradient-to-tl from-red-50 via-orange-100 to-yellow-200 blur-3xl w-screen h-screen rounded-full origin-top-left -rotate-12 -translate-x-[15rem]">
            </div>
        </div>
        <!-- End Gradients -->
        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20 min-h-screen">
            <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
                ...
                <div class="text-center">
                    ...
                    <h1 class="text-2xl text-indigo-600 font-bold sm:text-3xl lg:text-4xl lg:leading-tight">
                        Change your <span class="text-blue-500">Password</span>
                    </h1>
                </div>
                <!-- End Title -->
                ...
                <form wire:submit.prevent="changePassword"
                    class="max-w-2xl min-w-[24rem] mx-auto p-6 bg-white shadow-md rounded-lg">
                    @csrf
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            <input wire:model.live="currentPassword" type="password" id="currentPassword"
                                name="currentPassword"
                                class="py-2 px-4 block w-full border-gray-300 rounded-lg text-sm focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none"
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            <input wire:model.live="newPassword" type="password" id="newPassword" name="newPassword"
                                class="py-2 px-4 block w-full border-gray-300 rounded-lg text-sm focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none"
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            <input wire:model="passwordConfirmation" type="password" id="confirm-password"
