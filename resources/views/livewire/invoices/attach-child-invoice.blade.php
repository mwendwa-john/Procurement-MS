                                        ...
                                        <table class="min-w-full divide-y divide-gray-200">
                                            ...
                                            <tbody id="items-table-body" class="bg-white divide-y divide-gray-200">
                                                ...
                                                <tr
                                                    ...
                                                    <td class="px-3 py-2 whitespace-nowrap">
                                                        <input
                                                            wire:model.live.debounce.500ms="lpoItems.{{ $index }}.new_delivered_quantity"
                                                            type="number"
                                                    ...
                                                    <td class="px-3 py-2 whitespace-nowrap">
                                                        <input
                                                            wire:model.live.debounce.500ms="lpoItems.{{ $index }}.new_pending_quantity"
                                                            type="number"
