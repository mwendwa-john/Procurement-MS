    ...
    <div class="flex flex-wrap items-center space-x-3 mb-4 sm:mb-0">
        <div class="inline-flex flex-wrap rounded-lg shadow-sm">
            ...
            <a href="{{ route('invoices.show') }}"
                class="py-2 px-3 inline-flex justify-center items-center gap-2 -ms-px first:rounded-s-lg first:ms-0 last:rounded-e-lg text-sm font-medium focus:z-10 border border-gray-200 bg-blue-600 text-white shadow-sm hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
            ...
            <a href="{{ route('invoices.unpaid') }}"
                class="py-2 px-3 inline-flex justify-center items-center gap-2 -ms-px first:rounded-s-lg first:ms-0 last:rounded-e-lg text-sm font-medium focus:z-10 border border-gray-200 bg-orange-500 text-white shadow-sm hover:bg-orange-400 focus:outline-none focus:bg-orange-400">
                <button type="button" class="disabled:opacity-50 disabled:pointer-events-none">
                    Unpaid Invoices
                </button>
            </a>
            ...
            <a href="{{ route('invoices.partially.paid') }}"
                class="py-2 px-3 inline-flex justify-center items-center gap-2 -ms-px first:rounded-s-lg first:ms-0 last:rounded-e-lg text-sm font-medium focus:z-10 border border-gray-200 bg-teal-500 text-white shadow-sm hover:bg-teal-400 focus:outline-none focus:bg-teal-400">
                <button type="button" class="disabled:opacity-50 disabled:pointer-events-none">
                    Partially paid Invoices
                </button>
            </a>
            ...
            <a href="{{ route('invoices.paid') }}"
                class="py-2 px-3 inline-flex justify-center items-center gap-2 -ms-px first:rounded-s-lg first:ms-0 last:rounded-e-lg text-sm font-medium focus:z-10 border border-gray-200 bg-emerald-400 text-white shadow-sm hover:bg-emerald-300 focus:outline-none focus:bg-emerald-300">
                <button type="button" class="disabled:opacity-50 disabled:pointer-events-none">
                    Fully Paid Invoices
                </button>
            </a>
