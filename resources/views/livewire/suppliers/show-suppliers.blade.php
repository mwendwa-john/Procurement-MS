        ...
        <div
            ...
            <header class="w-full bg-white shadow-md p-3 px-4 flex items-center justify-between rounded-2xl">
                <div class="inline-flex items-center gap-x-2">
                    ...
                    <h1 class="text-xl font-bold text-gray-900 mt-1">Suppliers</h1>
                </div>
            </header>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="size-px whitespace-nowrap">
                                                <div class="px-6 py-1.5">
                                                    ...
                                                    <a class="inline-flex items-center gap-x-1 px-1.5 text-sm text-red-400 decoration-2 hover:underline font-medium"
                                                        href="#">
                                                        Delete
                                                    </a>
                                                </div>
